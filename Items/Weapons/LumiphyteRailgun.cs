...
{
	public class LumiphyteRailgun : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("A stronger railgun. It's full auto");
		}

		public override void SetDefaults()
		{
			item.damage = 425; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
			...
			(int)(item.shootSpeed = 20f); // the speed of the projectile (measured in pixels per frame)
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<LuminiteRailgun>());
			recipe.AddIngredient(ItemID.ChlorophyteBar, 25);
			recipe.AddIngredient(ItemID.Cog, 5);
			recipe.AddIngredient(ItemID.Wire, 20);
			recipe.AddTile(TileID.MythrilAnvil);
			recipe.SetResult(ModContent.ItemType<LumiphyteRailgun>());
