...
{
	public class AmberRailgun : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("A stronger version of the Luminite Railgun that fires in bursts.");
		}

		public override void SetDefaults()
		{
			item.damage = 475; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
			...
			item.useAmmo = ModContent.ItemType<EnergyShell>();
			item.reuseDelay = 10;
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.SetResult(ModContent.ItemType<AmberRailgun>());
